...
set(hObject,'Color',[0.7 0.7 0.7]) % RL (Sept 28, 2017)
set(0,'CurrentFigure',hObject) % RL (Sept 28, 2017)
...
% modified by RL (Sept 28, 2017)
text_str = cell(4,1);
text_str(1) = {'Voxel at: '};
text_str(2) = {['[X:' int2str(handles.pointer3dt(1)) ...
           ', Y:' int2str(handles.pointer3dt(2)) ...
           ', Z:' int2str(handles.pointer3dt(3)) ...
           ']']};
text_str(3) = {'Voxel Value: '};
text_str(4) = {num2str(value3dt)};
